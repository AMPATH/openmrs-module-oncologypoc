...
<!--						<div>-->
<!--						-->
<!-- MODIFICATIONS FOR PATIENT SCHEDULER ON THE RIGHT HAND SIDE OF PATIENT SEARCH WIDGET-ONCOLOGY -->
<!---->
<!--							<openmrs:extensionPoint pointId="org.openmrs.findPatientPortlet" type="html">-->
